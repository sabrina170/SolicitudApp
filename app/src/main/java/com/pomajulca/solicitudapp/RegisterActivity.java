...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void callRegister(View view) {
        ...
        if (correo.isEmpty() || tipo.isEmpty() || descripcion.isEmpty()) {
            Toast.makeText(this, "El correo , tipo , descripcion son campos requeridos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createSolicitud(correo, tipo, descripcion);
        } else {
            ...
            call = service.createSolicitudWithImage(correoPart, tipoPart, descripcionPart, imagenPart);
        }
